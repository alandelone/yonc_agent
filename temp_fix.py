...
def resolve_notion_inconsistencies():
    ...
    # By setting has_tag_style to False, we trick the sync engine into thinking
    # every task is unformatted. This forces it to run our new auto-detection
    # logic and push the corrected formatting to Notion.
    for task in state:
